 ...
 *
 *   Description: Returns whather the type is a value type.
 */
 ...
 *   Descritption: Given a type, check to see if it is compatible.
 */
 ...
 *  Description: Checks to see if the type is a pointer.
 */
...
/*
 *   Function: isInteger
 *   Descriton: Checks to see if the following is a integer.
 */
 ...
 *   Description: Promotes a given type appropriately.
 */
